...
public class QuantumExpressionStatementImpl extends ASTWrapperPsiElement implements QuantumExpressionStatement {

  public QuantumExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
