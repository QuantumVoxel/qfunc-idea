...
public class QuantumContinueStatementImpl extends ASTWrapperPsiElement implements QuantumContinueStatement {

  public QuantumContinueStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
