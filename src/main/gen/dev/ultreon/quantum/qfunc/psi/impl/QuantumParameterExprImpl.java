...
public class QuantumParameterExprImpl extends ASTWrapperPsiElement implements QuantumParameterExpr {

  public QuantumParameterExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public QuantumParamName getParamName() {
    return findNotNullChildByClass(QuantumParamName.class);
  }
