...
public class QuantumOrExprImpl extends ASTWrapperPsiElement implements QuantumOrExpr {

  public QuantumOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public QuantumNegationExpr getNegationExpr() {
    return findNotNullChildByClass(QuantumNegationExpr.class);
  }

  @Override
  @Nullable
  public QuantumOrExpr getOrExpr() {
    return findChildByClass(QuantumOrExpr.class);
  }
