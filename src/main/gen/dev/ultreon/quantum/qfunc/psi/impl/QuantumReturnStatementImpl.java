...
public class QuantumReturnStatementImpl extends ASTWrapperPsiElement implements QuantumReturnStatement {

  public QuantumReturnStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
