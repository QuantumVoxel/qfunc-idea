...
public class QuantumLoopStatementImpl extends ASTWrapperPsiElement implements QuantumLoopStatement {

  public QuantumLoopStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
