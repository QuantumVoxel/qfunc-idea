...
public class QuantumEqualityExprImpl extends ASTWrapperPsiElement implements QuantumEqualityExpr {

  public QuantumEqualityExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public QuantumRelationalExpr getRelationalExpr() {
    return findNotNullChildByClass(QuantumRelationalExpr.class);
  }
