...
public class QuantumBitwiseOrExprImpl extends ASTWrapperPsiElement implements QuantumBitwiseOrExpr {

  public QuantumBitwiseOrExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public QuantumBitwiseOrExpr getBitwiseOrExpr() {
    return findChildByClass(QuantumBitwiseOrExpr.class);
  }

  @Override
  @NotNull
  public QuantumBitwiseXorExpr getBitwiseXorExpr() {
    return findNotNullChildByClass(QuantumBitwiseXorExpr.class);
  }
