...
public class QuantumParameterNameImpl extends ASTWrapperPsiElement implements QuantumParameterName {

  public QuantumParameterNameImpl(@NotNull ASTNode node) {
    super(node);
  }
