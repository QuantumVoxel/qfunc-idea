...
public class QuantumPrimaryImpl extends ASTWrapperPsiElement implements QuantumPrimary {

  public QuantumPrimaryImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public QuantumAtom getAtom() {
    return findNotNullChildByClass(QuantumAtom.class);
  }
