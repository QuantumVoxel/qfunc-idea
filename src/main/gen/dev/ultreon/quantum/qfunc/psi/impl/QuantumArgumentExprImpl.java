...
public class QuantumArgumentExprImpl extends ASTWrapperPsiElement implements QuantumArgumentExpr {

  public QuantumArgumentExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull QuantumVisitor visitor) {
    visitor.visitArgumentExpr(this);
  }
  ...
  @Override
  @Nullable
  public QuantumParameterName getParameterName() {
    return findChildByClass(QuantumParameterName.class);
  }
