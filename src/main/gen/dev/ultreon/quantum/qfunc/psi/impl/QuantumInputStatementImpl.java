...
public class QuantumInputStatementImpl extends ASTWrapperPsiElement implements QuantumInputStatement {

  public QuantumInputStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<QuantumParamName> getParamNameList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, QuantumParamName.class);
  }
