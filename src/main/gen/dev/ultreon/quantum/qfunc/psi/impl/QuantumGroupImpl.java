...
public class QuantumGroupImpl extends ASTWrapperPsiElement implements QuantumGroup {

  public QuantumGroupImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public QuantumAndExpr getAndExpr() {
    return findNotNullChildByClass(QuantumAndExpr.class);
  }
