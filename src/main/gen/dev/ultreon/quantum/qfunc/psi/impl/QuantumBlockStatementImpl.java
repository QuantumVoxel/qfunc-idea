...
public class QuantumBlockStatementImpl extends ASTWrapperPsiElement implements QuantumBlockStatement {

  public QuantumBlockStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
