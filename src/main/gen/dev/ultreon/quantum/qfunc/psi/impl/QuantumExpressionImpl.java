...
public class QuantumExpressionImpl extends ASTWrapperPsiElement implements QuantumExpression {

  public QuantumExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public QuantumGroup getGroup() {
    return findNotNullChildByClass(QuantumGroup.class);
  }
