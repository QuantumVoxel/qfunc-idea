...
public class QuantumStopStatementImpl extends ASTWrapperPsiElement implements QuantumStopStatement {

  public QuantumStopStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
